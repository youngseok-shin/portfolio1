...
<body>
		...
		<div>
			<form>
				<article class="cart-wrap">
					...
					<ul class="cart-step">
						<li><span class="active">주문서 작성</span> <span class="last">주문완료</span>
						</li>
					</ul>
					<div id="normalList" class="order-lists normal">
						...
						<table class="table table-order-desktop">
							...
							<tbody id="cartItemList">
								<tr>
									<td class="select-order text-left"><span class="checkbox"></span>
									</td>
									<td class="thumb"><a href="/Product/KEXEX21550WHX"> <img
											src="/images/${goods.fileName }" width="150px;"
											height="200px;"></a></td>
									<td class="product text-left"><h4>
											<small style="font-size: x-small;">${goods.goodsId }</small>
										</h4>
										<p>
											<a href="shopPage.do">${goods.goodsName }</a>
										</p>
									<td class="price" id="dispPrice">${goods.goodsPrice }</td>
									<td class="range">
										<ul class="meta">
											<li>수량 : <span> <input type="text" id="goodsCnt"
													value="${goodsCnt }" min="1" style="width: 35px;">



											</span></li>
											<li>옵션 : <span>${goodsColor }</span></li>
										</ul>
									</td>
								</tr>
							</tbody>
					...
					<div class="billing-v2">
						...
						<div class="total">
							<div>
								<strong>총 주문금액</strong> <span id=""> <em
									class="totalPrice" id="totalPrice">${goods.totalPrice }</em>원
								</span>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="fdata">
								<input type="text" id="email" class="ip_text sm"
									name="custEmailId" title="이메일 아이디" value="" maxlength="25">
								<em class="unit">@</em> <input type="text" class="ip_text sm"
									name="custEmailDomain" title="이메일 도메인 주소" value=""
									maxlength="20"> <span class="select_box"
									style="width: 220px"> </span> <em class="ip_info">* 주문내역이
									이메일로 발송됩니다.</em>
							</div>
						</div>
						<div class="row">
							...
							<div class="fdata" id="originCellNo2">
								...
								<span class="select_box"> <select title="휴대폰 앞 번호"
									id="originCellNo1" name="originCellNo1"
									style="width: 100px; height: 45px; margin-bottom: 10px; background: #fafafa; border: 1px solid #dbdbdb;">
								...
								</span> <input type="text" class="ip_text sm" id="originCellNo2"
									name="originCellNo2" title="휴대폰 가운데 번호" value=""> <input
									type="text" class="ip_text sm" id="originCellNo3"
									name="originCellNo3" title="휴대폰 마지막 번호" value="">
							</div>
							<!-- //default -->
							...
							<div class="fdata">
								<div class="block">
									<input type="text" class="ip_text sm" id="sample6_postcode"
										...
										maxlength="6"> <input type="button"
										class="btn btn-line btn-big" id="postFind01"
										onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
								</div>
								<input type="text" class="ip_text xl" id="sample6_address"
									name="custAddr1" readonly title="기본 주소" value=""
									maxlength="120"> <input type="text" class="ip_text xl"
									id="sample6_extraAddress" name="custAddr2" title="상세 주소"
									value="" maxlength="120"> <input type="hidden"
									id="sample6_detailAddress" placeholder="참고항목">
							</div>
						</div>
					</div>
					<div class="cart-info">
						<div class="col">
							...
							<ul class="bul-list">
								...
								<li>오프라인 매장과 동시 판매되고 있으므로, 결제완료 후 또는 입고 확정 이후에도 품절/결품이 발생될
									수 있으며, 재고 확인으로 인한 발송 지연도 있을 수 있습니다.</li>
	...
	<script src="resources/js/shopOneBuy.js?ver=3"></script>
</body>
</html>