...
<div class="layout2">
	   ...
	   <div id="paginationBox">
	      <ul class="pagination">
	         ...
	         <c:forEach begin="${mv.startPage}" end="${mv.endPage}" var="idx">
	            <li class="page-item <c:out value="${messageVO.page == idx ? 'active' : ''}"/> "><a class="page-link" href="#" onClick="fn_pagination('${idx}', '${mv.range}', '${subMenu }', '${mv.rangeSize}')"> ${idx} </a></li>
	         </c:forEach>
	         <c:if test="${mv.next}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="letterSendForm.do" method="post" id="letterSendForm">
						<input type="hidden" name="sId"
							value="${sessionScope.loginInfo.memberId }"> <input
							class="form-control" type="text" name="title"
							placeholder="제목을 입력하세요">
						<div style="height: 5px;"></div>
						<textarea class="form-control" rows="10" cols="55" name="note"
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" value="보내기"
						id="sendBtn">
	...
	<script src="resources/js/userLetterInbox.js?ver=5"></script>
</body>
</html>