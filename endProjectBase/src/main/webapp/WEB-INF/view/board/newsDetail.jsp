...
<th style="font-size: x-large;" name="boardTitle"> ${newsBoard.boardTitle }</th> 
 <th align="right" width="200" name="boardWriter">
 ${newsBoard.boardWriter } l ${newsBoard.boardDate }</th>
...
<tr><td name="boardContent">${newsBoard.boardContent }</td></tr>
		...
		<div class="keep_right">
			...
			<c:if test="${sessionScope.loginInfo.memberId eq 'admin' }">
				<!--  admin만 보이게 -->
					...
					onclick="location.href='board14.do?boardNum=${newsBoard.boardNum }'" type="button">
					<span>수정</span>
				</button>
					...
					onclick="location.href='board10.do?boardNum=${newsBoard.boardNum}'">
