...
<body>
	...
	<form action="board15.do?boardNum=${newsBoard.boardNum }" method="post">
<!-- 	
	...
	<div class="layout">
		...
		<header>
			<div style="margin-top: 21px;">
				<h2>관리자 뉴스소식 &emsp; &emsp; &emsp;&emsp; &emsp; &emsp; &emsp;
			...
			<table>
				...
				<tbody class="board_form">
					<tr>
						...
						<td><input type="text"  name="boardTitle" value="${newsBoard.boardTitle }"></td>
					...
					<tr>
						...
						<td>
							...
							</p> <label></label> <input type="file" onchange="" title="첨부파일1">
						</td>
					</tr>
					...
					<tr class="middle">
						...
						<td>
						<textarea rows="15" cols="1"
								style="width: 100%; height: 300;" class="textArea" name="boardContent" >${newsBoard.boardContent }
		...
		<div class="last_button">
			<div class="keep_right">
				...
				<button title="목록" class="btn_gray"	 onclick="location.href='board.do'; return false;" type="button">
					<span>목록</span>
				</button>
