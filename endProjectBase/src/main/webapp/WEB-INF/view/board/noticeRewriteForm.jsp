...
<body>
	...
	<form action="board21.do?boardNum=${vv.boardNum }" method="post">
<!-- 	
			...
			<table>
				...
				<tbody class="board_form">
					<tr>
						...
						<td><input type="text"  name="boardTitle" value="${vv.boardTitle }"></td>
					...
					<tr class="middle">
						...
						<textarea rows="15" cols="1"
								style="width: 100%; height: 300;" class="textArea" name="boardContent" >${vv.boardContent }
