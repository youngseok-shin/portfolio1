...
<body>
	...
	<div class="layout">
		...
		<form action="board6.do" method="post" enctype="multipart/form-data">
				...
				<table>
					<tbody class="board_form">
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" value="${sessionScope.loginInfo.memberId }" name="boardWriter" readonly>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select style="width: 100%;" id="chkDoNm">
									<c:choose>
										<c:when test="${doNms != null}">
											<option value="${doNms }">${doNms }</option>	
										</c:when>
										<c:otherwise>
							...
							<td>
								<select style="width: 100%;" id="chkSigungu">
									<c:choose>
										<c:when test="${sigunguNms != null}">
											<option value="${sigunguNms }">${sigunguNms }</option>	
										</c:when>
										<c:otherwise>
							...
							<td>
								<select style="width: 100%;" id="chkSite" name="facltNm">
									<c:choose>
										<c:when test="${facltNms != null}">
											<option value="${facltNms }">${facltNms }</option>						
										</c:when>
										<c:otherwise>
						...
						<tr>
							...
							<td colspan="3">
								<p>
									<input type="file" title="첨부파일1" name="file1" placeholder="대표이미지" accept="image/*"> 
								</p>
						...
						<tr class="middle">
							...
							<td colspan="3"><textarea rows="15" cols="1"
	...
	<script src="resources/js/reviewBoard.js?ver=811"></script>
</body>
</html>